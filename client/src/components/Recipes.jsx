    ...
    <div>
      ...
      <div className="recipes-container">
        ...
        <div className="image1">
          <h3 className="recipe-name">Fried Chicken</h3>
          <a className="anchor" rel="noreferrer" target="_blank" href="https://drive.google.com/file/d/1Sy49E8yEx5B710hD9NP3mtFmMKhh1qJS/view?usp=sharing">
        ...
        <h3 className="recipe-name">Roasted Chicken</h3>
          ...
          <a className="anchor" rel="noreferrer" target="_blank" href="https://drive.google.com/file/d/16qcBTxpKpDA5eGg6Y5V2jdLul_4IVQC_/view?usp=sharing">
        ...
        <div className="image1">
        <h3 className="recipe-name">Chicken Soup</h3>

          <a className="anchor" rel="noreferrer" target="_blank" href="https://drive.google.com/file/d/1dFtdS6VLKq13wFzEsFb3RtxkxKuAM2mD/view?usp=sharing">
